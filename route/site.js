...
function siteRoute(router) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        siteAuth.get('/products/of/:typeId', (ctx) => __awaiter(this, void 0, void 0, function* () {
            ctx.body = new utils_1.MsgRes(true, '', yield CProductSite_1.CProductSite.getByTypeId(ctx.state.user.role.products, ctx.params.typeId));
        }));
        siteAuth.get('/product/:productId/platform/product/onsale', (ctx) => __awaiter(this, void 0, void 0, function* () {
            ctx.body = new utils_1.MsgRes(true, '', yield CProductSite_1.CProductSite.productPlatformOnsale(ctx.params.productId));
        }));
        ...
        siteAuth.get('/product/price/batch/back', (ctx) => __awaiter(this, void 0, void 0, function* () {
            yield CProductSite_1.CProductSite.priceBatchBack(ctx.state.user.role.products);
            let io = ctx.io;
            let siteId = ctx.state.user.site.id;
            io.emit(siteId + 'batchUpdateProductPrice');
            ctx.body = new utils_1.MsgRes(true, '', null);
        ...
        siteAuth.post('/admin/username/exist', (ctx) => __awaiter(this, void 0, void 0, function* () {
        ...
        siteAuth.post('/user/username/exist', (ctx) => __awaiter(this, void 0, void 0, function* () {
        ...
        siteAuth.post('/site/name/exist', (ctx) => __awaiter(this, void 0, void 0, function* () {
